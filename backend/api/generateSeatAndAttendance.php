...
if($method == "GET"){
    ...
    try{
        ...
        $seat_room_ids = array();
        $distinct_seat_room_q = "SELECT DISTINCT seat_room FROM DummyApplicantAdmit";
        ...
        foreach($seat_room_ids as $seat_room_id){
            ...
            $room_info_q = "SELECT * FROM DummySeatRoom WHERE ROOM_ID=".$seat_room_id;
            ...
            $verified_user_query = "SELECT * FROM DummyApplicantAdmit WHERE seat_room=".$seat_room_id;
            ...
            for ($i = 0; $i < ceil($totalItems/$itemsPerPage); $i++) {
                ...
                for ($j = 0; $j < $itemsPerPage; $j++) {
                    ...
                    $index = $i * $itemsPerPage + $j; echo $index.'-';
                    ...
                    if ($index < $totalItems) {
                        ...
                        $roll_query = "SELECT * FROM DummyApplicantAdmit WHERE U_ID=".$u_id;
